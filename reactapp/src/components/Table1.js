...
this.dataStore=[];
    this.state = {
      columnDefs: [{
        ...
        headerName: "Bid", field: "bid", sortable: true, filter: true, resizable: true
      }, {
        headerName: "Ask", field: "ask", sortable: true, filter: true, resizable: true
      }, {
        headerName: "bsize", field: "bsize", sortable: true, filter: true, resizable: true
      }, {
        headerName: "asize", field: "asize", sortable: true, filter: true, resizable: true
      }],
        dataStore:[]
   ...
   updateData() {
       this.getData("30#select from quote")
           .then(data => {
               if (data.success) {
